...
import cn.mepstudio.photocompressor.Settings.AboutActivity;
import cn.mepstudio.photocompressor.Settings.HelpActivity;
...
public class SettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView text_path,text_files_name;
   ...
   //?
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_files_name = (TextView) findViewById(R.id.btn_files_name);
        ...
        text_tip = (TextView) findViewById(R.id.btn_tip);
      ...
      //  text_more.setOnClickListener(this);
        ...
        text_path.setText(String.format("保存位置:内置储存"));
        text_files_name.setText(String.format("文件夹名:"+ userSettings.getString("user_defined_files","")));
    }
...
//sbar_quality.getProgress()
            ...
            case R.id.btn_path:
                final String[] path = new String[] { "内部储存","外置储存卡"};
                final AlertDialog.Builder builder = new AlertDialog.Builder(this);
                // 设置标题
                builder.setTitle("选择储存位置").
                        // 设置可选择的内容，并添加点击事件
                                setItems(path, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                // which代表的是选择的标签的序列号
                               if(path[which]=="内部储存"){
                                   ...
                                   Toast.makeText(getApplicationContext(), "暂时还不能选择外置内存卡哦！", Toast.LENGTH_LONG).show();
                               }
                            }
                        }).
                        // 产生对话框，并显示出来
            ...
            case R.id.btn_tip:
                    final ImageView pay_img = new ImageView(this);
                    pay_img.setImageResource(R.drawable.wx_pay);
                    new  AlertDialog.Builder(this)
                            .setTitle("赏我一杯可乐吧！" )
                            .setIcon(android.R.drawable.ic_dialog_info)
                            .setView(pay_img)
