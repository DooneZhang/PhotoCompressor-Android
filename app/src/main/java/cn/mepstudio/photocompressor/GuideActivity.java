...
import cn.mepstudio.photocompressor.Utils.GuidePageAdapter;
...
public class GuideActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener{
    ...
    private void initViewPager() {
        ...
        //实例化图片资源
        imageIdArray = new int[]{R.drawable.guide_image1,R.drawable.guide_image2};
    ...
    protected void onResume() {
        super.onResume();
        MiStatInterface.recordPageStart(this, "引导界面");
    }
